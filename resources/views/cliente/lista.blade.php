                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="email" type="text" class="form-control" id="email" value="{{ $cliente->email }}" aria-describedby="emailHelp">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tipo_documento" id="tipo_documento"  class="form-control selectpicker" data-live-search="true" data-size="3" data-dropup-auto="false">
                                                            ...
                                                            <option
                                                                @if($cliente->tipo_documento == "carnet_identidad")
                                                                    value="{{ $cliente->tipo_documento }}" selected
                                                                @endif>Carnet_Identidad
                                                            </option>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="num_documento" type="text" class="form-control" id="num_documento" aria-describedby="emailHelp" value="{{ $cliente->num_documento }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label for="telefono">Teléfono</label>
                                                        <input name="telefono" type="text" class="form-control" id="telefono" aria-describedby="emailHelp" value="{{ $cliente->telefono }}" >
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
